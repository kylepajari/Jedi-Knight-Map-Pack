...
namespace MapScripts
{
    ...
    public class CTF3Triggers : ColliderListener
    {
        ...
        public override void OnTriggerEnter(Collider col)
        {
            ...
            {
                //plats
                if (transform.name == "func_door_t5" || transform.name == "func_door_t4" || transform.name == "func_door_t3" || transform.name == "func_door_bluesidelift" || transform.name == "func_door_bluesidelift2" || transform.name == "func_door_bluesidelift3")
                {
                    int i = CTF3Movement.plats.IndexOf(transform.gameObject);
                    ...
                    if (CTF3Movement.platsPersonsInside[i].IndexOf(person) == -1 && fullyInside)
                    {
                        //add person to list of people inside
                        CTF3Movement.platsPersonsInside[i].Add(person);
                        CTF3Movement.canMove = false;
                        CTF3Movement.SetTimer();
                    }
                }
            }
        }
